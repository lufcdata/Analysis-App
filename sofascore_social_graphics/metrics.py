...
METRICS: list[dict[str, Any]] = [
    ...
    {"label": "Opposition Box Touches", "sofascore": "Penalty Box Touches", "match_aliases": ["Penalty box touches", "Touches in opposition box", "Touches in Opposition Box", "Touches in penalty area", "Touches in penalty box", "Touches inside opposition box"], "match_keys": ["touchesInOppBox", "touchesInOppositionBox", "penaltyBoxTouches", "touchesInPenaltyArea", "touchesInPenaltyBox", "touchesInsideOppositionBox"], "player_keys": ["touchesInOppBox", "touchesInOppositionBox", "penaltyBoxTouches", "touchesInPenaltyArea"]},
