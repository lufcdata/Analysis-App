...
st.markdown(
    ...
    [data-testid="stSidebar"] { background-color: #1e1c2e; border-right: 1px solid #343149; }
    ...
    .stTextInput input {
        background-color: #2f2d44 !important;
        color: #fafafc !important;
        border-color: #46435e !important;
    }
...
with st.sidebar:
    ...
    load_clicked = st.button("Load Match", type="primary", width="stretch")
...
if graphic_type == "Match Statistics":
    ...
    preview_col, action_col = st.columns([2.15, 0.85], gap="large")
    with preview_col:
